...
// Định nghĩa hàm này trước khi gọi trong handleQuizData
...
window.handleQuizData = function(data) {
    ...
    if (studentCodeInput) studentCodeInput.style.display = 'none';
    
    alert("Tải dữ liệu thành công!");
    
    // Gọi hàm updateTopicList sau khi đã chắc chắn dữ liệu được gán
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Bổ sung sự kiện onchange cho select để cập nhật danh sách chủ đề khi đổi môn
